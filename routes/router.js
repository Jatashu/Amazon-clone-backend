...
router.get("/getproducts", async (req, res) => {
    try {
        ...
        // console.log(producstdata + "Getting products data");
...
router.post("/register", async (req, res) => {
    ...
    try {
        ...
        console.log("error registratoin time" + error.message);
...
router.post("/addcart/:id", authenicate, async (req, res) => {
    ...
    try {
        ...
        console.log(Usercontact + "Getting user");
        ...
        if (Usercontact) {
            ...
            console.log(cartData + " these save wait kr");
...
router.get("/cartdetails", authenicate, async (req, res) => {
    try {
        ...
        console.log(buyuser + "user in buy page");
